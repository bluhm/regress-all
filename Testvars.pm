...
my @testdesc = (
    ...
    'ssh_root@lt{left}_ping6_-qfc10000_{prefix}{line}1::2'				=> { ipv => "IPv6", proto => "ICMP", op => "Receive", len => "",      streams => "",             name => "linux-openbsd-icmp6" },
    'ssh_root@lt{left}_ping6_-qfc10000_{prefix}{line}2::4'				=> { ipv => "IPv6", proto => "ICMP", op => "Forward", len => "",      streams => "",             name => "linux-openbsd-linux-icmp6" },
    'ssh_root@lt{left}_ping_-qfc10000_{prefix}{line}1.2'				=> { ipv => "IPv4", proto => "ICMP", op => "Receive", len => "",      streams => "",             name => "linux-openbsd-icmp4" },
    'ssh_root@lt{left}_ping_-qfc10000_{prefix}{line}2.4'				=> { ipv => "IPv4", proto => "ICMP", op => "Forward", len => "",      streams => "",             name => "linux-openbsd-linux-icmp4" },
    ...
    'ssh_root@lt{left}_udpbench_-l1453_-t10_-r_root@lt{right}_send_{prefix}{line}2::4'	=> { ipv => "IPv6", proto => "UDP",  op => "Forward", len => "Frags", streams => "single",       name => "linux-openbsd-linux-udp6bench-frag" },
    'ssh_root@lt{left}_udpbench_-l1473_-t10_-r_root@lt{right}_send_{prefix}{line}2.4'	=> { ipv => "IPv4", proto => "UDP",  op => "Forward", len => "Frags", streams => "single",       name => "linux-openbsd-linux-udp4bench-frag" },
    'udpbench_-l1473_-t10_-r_root@lt{left}_recv_{prefix}{line}1.2'			=> { ipv => "IPv4", proto => "UDP",  op => "Receive", len => "Frags", streams => "single",       name => "linux-openbsd-udp4bench-frag" },
    'ssh_root@lt{left}_udpbench_-l1452_-t10_-r_root@lt{right}_send_{prefix}{line}2::4'	=> { ipv => "IPv6", proto => "UDP",  op => "Forward", len => "Long",  streams => "single",       name => "linux-openbsd-linux-udp6bench-long" },
    'ssh_root@lt{left}_udpbench_-l1472_-t10_-r_root@lt{right}_send_{prefix}{line}2.4'	=> { ipv => "IPv4", proto => "UDP",  op => "Forward", len => "Long",  streams => "single",       name => "linux-openbsd-linux-udp4bench-long" },
    'ssh_root@lt{left}_udpbench_-l36_-t10_-r_root@lt{right}_send_{prefix}{line}2.4'	=> { ipv => "IPv4", proto => "UDP",  op => "Forward", len => "Short", streams => "single",       name => "linux-openbsd-linux-udp4bench-short" },
    'ssh_root@lt{left}_udpbench_-l36_-t10_-r_root@lt{right}_send_{prefix}{line}2::4'	=> { ipv => "IPv6", proto => "UDP",  op => "Forward", len => "Short", streams => "single",       name => "linux-openbsd-linux-udp6bench-short" },
    'udpbench_-l1452_-t10_-r_root@lt{left}_recv_{prefix}{line}1::2'			=> { ipv => "IPv6", proto => "UDP",  op => "Receive", len => "Long",  streams => "single",       name => "linux-openbsd-udp6bench-long" },
    'udpbench_-l1452_-t10_-r_root@lt{right}_send_{prefix}{line}2::4'			=> { ipv => "IPv6", proto => "UDP",  op => "Send",    len => "Long",  streams => "single",       name => "openbsd-linux-udp6bench-long" },
    'udpbench_-l1453_-t10_-r_root@lt{left}_recv_{prefix}{line}1::2'			=> { ipv => "IPv6", proto => "UDP",  op => "Receive", len => "Frags", streams => "single",       name => "linux-openbsd-udp6bench-frag" },
    'udpbench_-l1453_-t10_-r_root@lt{right}_send_{prefix}{line}2::4'			=> { ipv => "IPv6", proto => "UDP",  op => "Send",    len => "Frags", streams => "single",       name => "openbsd-linux-udp6bench-frag" },
    'udpbench_-l1472_-t10_-r_root@lt{left}_recv_{prefix}{line}1.2'			=> { ipv => "IPv4", proto => "UDP",  op => "Receive", len => "Long",  streams => "single",       name => "linux-openbsd-udp4bench-long" },
    'udpbench_-l1472_-t10_-r_root@lt{right}_send_{prefix}{line}2.4'			=> { ipv => "IPv4", proto => "UDP",  op => "Send",    len => "Long",  streams => "single",       name => "openbsd-linux-udp4bench-long" },
    'udpbench_-l1473_-t10_-r_root@lt{right}_send_{prefix}{line}2.4'			=> { ipv => "IPv4", proto => "UDP",  op => "Send",    len => "Frags", streams => "single",       name => "openbsd-linux-udp4bench-frag" },
    'udpbench_-l36_-t10_-r_root@lt{left}_recv_{prefix}{line}1.2'			=> { ipv => "IPv4", proto => "UDP",  op => "Receive", len => "Short", streams => "single",       name => "linux-openbsd-udp4bench-short" },
    'udpbench_-l36_-t10_-r_root@lt{left}_recv_{prefix}{line}1::2'			=> { ipv => "IPv6", proto => "UDP",  op => "Receive", len => "Short", streams => "single",       name => "linux-openbsd-udp6bench-short" },
    'udpbench_-l36_-t10_-r_root@lt{right}_send_{prefix}{line}2.4'			=> { ipv => "IPv4", proto => "UDP",  op => "Send",    len => "Short", streams => "single",       name => "openbsd-linux-udp4bench-short" },
    'udpbench_-l36_-t10_-r_root@lt{right}_send_{prefix}{line}2::4'			=> { ipv => "IPv6", proto => "UDP",  op => "Send",    len => "Short", streams => "single",       name => "openbsd-linux-udp6bench-short" },
    'netbench.pl_-v_-b1000000_-f0_-croot@lt{left}_-a{prefix}{line}1.20_-t10_udpbench'			=> { ipv => "IPv4", proto => "UDP",  op => "Receive", len => "Empty", streams => "single",       name => "linux-openbsd-udp4bench-single-empty" },
    'netbench.pl_-v_-b1000000_-f0_-croot@lt{left}_-a{prefix}{line}1::20_-t10_udpbench'			=> { ipv => "IPv6", proto => "UDP",  op => "Receive", len => "Empty", streams => "single",       name => "linux-openbsd-udp6bench-single-empty" },
    'netbench.pl_-v_-b1000000_-f0_-croot@lt{left}_-sroot@lt{right}_-a{prefix}{line}2.40_-t10_udpbench'	=> { ipv => "IPv4", proto => "UDP",  op => "Forward", len => "Empty", streams => "single",       name => "linux-openbsd-linux-udp4bench-single-empty" },
    'netbench.pl_-v_-b1000000_-f0_-croot@lt{left}_-sroot@lt{right}_-a{prefix}{line}2::40_-t10_udpbench'	=> { ipv => "IPv6", proto => "UDP",  op => "Forward", len => "Empty", streams => "single",       name => "linux-openbsd-linux-udp6bench-single-empty" },
    'netbench.pl_-v_-b1000000_-f0_-sroot@lt{right}_-a{prefix}{line}2.40_-t10_udpbench'			=> { ipv => "IPv4", proto => "UDP",  op => "Send",    len => "Empty", streams => "single",       name => "openbsd-linux-udp4bench-single-empty" },
    'netbench.pl_-v_-b1000000_-f0_-sroot@lt{right}_-a{prefix}{line}2::40_-t10_udpbench'			=> { ipv => "IPv6", proto => "UDP",  op => "Send",    len => "Empty", streams => "single",       name => "openbsd-linux-udp6bench-single-empty" },
    'netbench.pl_-v_-b1000000_-f1_-croot@lt{left}_-a{prefix}{line}1.20_-t10_udpbench'			=> { ipv => "IPv4", proto => "UDP",  op => "Receive", len => "MTU",   streams => "single",       name => "linux-openbsd-udp4bench-single-mtu" },
    'netbench.pl_-v_-b1000000_-f1_-croot@lt{left}_-a{prefix}{line}1::20_-t10_udpbench'			=> { ipv => "IPv6", proto => "UDP",  op => "Receive", len => "MTU",   streams => "single",       name => "linux-openbsd-udp6bench-single-mtu" },
    'netbench.pl_-v_-b1000000_-f1_-croot@lt{left}_-sroot@lt{right}_-a{prefix}{line}2.40_-t10_udpbench'	=> { ipv => "IPv4", proto => "UDP",  op => "Forward", len => "MTU",   streams => "single",       name => "linux-openbsd-linux-udp4bench-single-mtu" },
    'netbench.pl_-v_-b1000000_-f1_-croot@lt{left}_-sroot@lt{right}_-a{prefix}{line}2::40_-t10_udpbench'	=> { ipv => "IPv6", proto => "UDP",  op => "Forward", len => "MTU",   streams => "single",       name => "linux-openbsd-linux-udp6bench-single-mtu" },
    'netbench.pl_-v_-b1000000_-f1_-sroot@lt{right}_-a{prefix}{line}2.40_-t10_udpbench'			=> { ipv => "IPv4", proto => "UDP",  op => "Send",    len => "MTU",   streams => "single",       name => "openbsd-linux-udp4bench-single-mtu" },
    'netbench.pl_-v_-b1000000_-f1_-sroot@lt{right}_-a{prefix}{line}2::40_-t10_udpbench'			=> { ipv => "IPv6", proto => "UDP",  op => "Send",    len => "MTU",   streams => "single",       name => "openbsd-linux-udp6bench-single-mtu" },
    'netbench.pl_-v_-b1000000_-f2_-croot@lt{left}_-a{prefix}{line}1.20_-t10_udpbench'			=> { ipv => "IPv4", proto => "UDP",  op => "Receive", len => "Frag2", streams => "single",       name => "linux-openbsd-udp4bench-single-frag" },
    'netbench.pl_-v_-b1000000_-f2_-croot@lt{left}_-a{prefix}{line}1::20_-t10_udpbench'			=> { ipv => "IPv6", proto => "UDP",  op => "Receive", len => "Frag2", streams => "single",       name => "linux-openbsd-udp6bench-single-frag" },
    'netbench.pl_-v_-b1000000_-f2_-croot@lt{left}_-sroot@lt{right}_-a{prefix}{line}2.40_-t10_udpbench'	=> { ipv => "IPv4", proto => "UDP",  op => "Forward", len => "Frag2", streams => "single",       name => "linux-openbsd-linux-udp4bench-single-frag" },
    'netbench.pl_-v_-b1000000_-f2_-croot@lt{left}_-sroot@lt{right}_-a{prefix}{line}2::40_-t10_udpbench'	=> { ipv => "IPv6", proto => "UDP",  op => "Forward", len => "Frag2", streams => "single",       name => "linux-openbsd-linux-udp6bench-single-frag" },
    'netbench.pl_-v_-b1000000_-f2_-sroot@lt{right}_-a{prefix}{line}2.40_-t10_udpbench'			=> { ipv => "IPv4", proto => "UDP",  op => "Send",    len => "Frag2", streams => "single",       name => "openbsd-linux-udp4bench-single-frag" },
    'netbench.pl_-v_-b1000000_-f2_-sroot@lt{right}_-a{prefix}{line}2::40_-t10_udpbench'			=> { ipv => "IPv6", proto => "UDP",  op => "Send",    len => "Frag2", streams => "single",       name => "openbsd-linux-udp6bench-single-frag" },
    'netbench.pl_-v_-B1000000000_-b1000000_-d1_-f0_-i0_-N10_-croot@lt{left}_-a{prefix}{line}1.20_-t10_udpbench'				=> { ipv => "IPv4", proto => "UDP",  op => "Receive", len => "Empty", streams => "parallel-10",  name => "linux-openbsd-udp4bench-parallel-empty" },
    'netbench.pl_-v_-B1000000000_-b1000000_-d1_-f0_-i0_-N10_-croot@lt{left}_-a{prefix}{line}1::20_-t10_udpbench'			=> { ipv => "IPv6", proto => "UDP",  op => "Receive", len => "Empty", streams => "parallel-10",  name => "linux-openbsd-udp6bench-parallel-empty" },
    'netbench.pl_-v_-B1000000000_-b1000000_-d1_-f0_-i0_-N10_-croot@lt{left}_-sroot@lt{right}_-a{prefix}{line}2.40_-t10_udpbench'	=> { ipv => "IPv4", proto => "UDP",  op => "Forward", len => "Empty", streams => "parallel-10",  name => "linux-openbsd-linux-udp4bench-parallel-empty" },
    'netbench.pl_-v_-B1000000000_-b1000000_-d1_-f0_-i0_-N10_-croot@lt{left}_-sroot@lt{right}_-a{prefix}{line}2::40_-t10_udpbench'	=> { ipv => "IPv6", proto => "UDP",  op => "Forward", len => "Empty", streams => "parallel-10",  name => "linux-openbsd-linux-udp6bench-parallel-empty" },
    'netbench.pl_-v_-B1000000000_-b1000000_-d1_-f0_-i0_-N10_-sroot@lt{right}_-a{prefix}{line}2.40_-t10_udpbench'			=> { ipv => "IPv4", proto => "UDP",  op => "Send",    len => "Empty", streams => "parallel-10",  name => "openbsd-linux-udp4bench-parallel-empty" },
    'netbench.pl_-v_-B1000000000_-b1000000_-d1_-f0_-i0_-N10_-sroot@lt{right}_-a{prefix}{line}2::40_-t10_udpbench'			=> { ipv => "IPv6", proto => "UDP",  op => "Send",    len => "Empty", streams => "parallel-10",  name => "openbsd-linux-udp6bench-parallel-empty" },
    'netbench.pl_-v_-B1000000000_-b1000000_-d1_-f1_-i0_-N10_-croot@lt{left}_-a{prefix}{line}1.20_-t10_udpbench'				=> { ipv => "IPv4", proto => "UDP",  op => "Receive", len => "MTU",   streams => "parallel-10",  name => "linux-openbsd-udp4bench-parallel-mtu" },
    'netbench.pl_-v_-B1000000000_-b1000000_-d1_-f1_-i0_-N10_-croot@lt{left}_-a{prefix}{line}1::20_-t10_udpbench'			=> { ipv => "IPv6", proto => "UDP",  op => "Receive", len => "MTU",   streams => "parallel-10",  name => "linux-openbsd-udp6bench-parallel-mtu" },
    'netbench.pl_-v_-B1000000000_-b1000000_-d1_-f1_-i0_-N10_-croot@lt{left}_-sroot@lt{right}_-a{prefix}{line}2.40_-t10_udpbench'	=> { ipv => "IPv4", proto => "UDP",  op => "Forward", len => "MTU",   streams => "parallel-10",  name => "linux-openbsd-linux-udp4bench-parallel-mtu" },
    'netbench.pl_-v_-B1000000000_-b1000000_-d1_-f1_-i0_-N10_-croot@lt{left}_-sroot@lt{right}_-a{prefix}{line}2::40_-t10_udpbench'	=> { ipv => "IPv6", proto => "UDP",  op => "Forward", len => "MTU",   streams => "parallel-10",  name => "linux-openbsd-linux-udp6bench-parallel-mtu" },
    'netbench.pl_-v_-B1000000000_-b1000000_-d1_-f1_-i0_-N10_-sroot@lt{right}_-a{prefix}{line}2.40_-t10_udpbench'			=> { ipv => "IPv4", proto => "UDP",  op => "Send",    len => "MTU",   streams => "parallel-10",  name => "openbsd-linux-udp4bench-parallel-mtu" },
    'netbench.pl_-v_-B1000000000_-b1000000_-d1_-f1_-i0_-N10_-sroot@lt{right}_-a{prefix}{line}2::40_-t10_udpbench'			=> { ipv => "IPv6", proto => "UDP",  op => "Send",    len => "MTU",   streams => "parallel-10",  name => "openbsd-linux-udp6bench-parallel-mtu" },
    'netbench.pl_-v_-B1000000000_-b1000000_-d1_-f2_-i0_-N10_-croot@lt{left}_-a{prefix}{line}1.20_-t10_udpbench'				=> { ipv => "IPv4", proto => "UDP",  op => "Receive", len => "Frag2", streams => "parallel-10",  name => "linux-openbsd-udp4bench-parallel-frag" },
    'netbench.pl_-v_-B1000000000_-b1000000_-d1_-f2_-i0_-N10_-croot@lt{left}_-a{prefix}{line}1::20_-t10_udpbench'			=> { ipv => "IPv6", proto => "UDP",  op => "Receive", len => "Frag2", streams => "parallel-10",  name => "linux-openbsd-udp6bench-parallel-frag" },
    'netbench.pl_-v_-B1000000000_-b1000000_-d1_-f2_-i0_-N10_-croot@lt{left}_-sroot@lt{right}_-a{prefix}{line}2.40_-t10_udpbench'	=> { ipv => "IPv4", proto => "UDP",  op => "Forward", len => "Frag2", streams => "parallel-10",  name => "linux-openbsd-linux-udp4bench-parallel-frag" },
    'netbench.pl_-v_-B1000000000_-b1000000_-d1_-f2_-i0_-N10_-croot@lt{left}_-sroot@lt{right}_-a{prefix}{line}2::40_-t10_udpbench'	=> { ipv => "IPv6", proto => "UDP",  op => "Forward", len => "Frag2", streams => "parallel-10",  name => "linux-openbsd-linux-udp6bench-parallel-frag" },
    'netbench.pl_-v_-B1000000000_-b1000000_-d1_-f2_-i0_-N10_-sroot@lt{right}_-a{prefix}{line}2.40_-t10_udpbench'			=> { ipv => "IPv4", proto => "UDP",  op => "Send",    len => "Frag2", streams => "parallel-10",  name => "openbsd-linux-udp4bench-parallel-frag" },
    'netbench.pl_-v_-B1000000000_-b1000000_-d1_-f2_-i0_-N10_-sroot@lt{right}_-a{prefix}{line}2::40_-t10_udpbench'			=> { ipv => "IPv6", proto => "UDP",  op => "Send",    len => "Frag2", streams => "parallel-10",  name => "openbsd-linux-udp6bench-parallel-frag" },
    ...
    'ssh_root@lt{left}_tcpbench_-S1000000_-t10_-n100_{prefix}{line}2.4'		=> { ipv => "IPv4", proto => "TCP",  op => "Forward", len => "",      streams => "parallel-100", name => "linux-openbsd-linux-tcp4bench-parallel" },
    'ssh_root@lt{left}_tcpbench_-S1000000_-t10_-n100_{prefix}{line}2::4'	=> { ipv => "IPv6", proto => "TCP",  op => "Forward", len => "",      streams => "parallel-100", name => "linux-openbsd-linux-tcp6bench-parallel" },
    'ssh_root@lt{left}_tcpbench_-S1000000_-t10_{prefix}{line}2.4'		=> { ipv => "IPv4", proto => "TCP",  op => "Forward", len => "",      streams => "single",       name => "linux-openbsd-linux-tcp4bench-single" },
    'ssh_root@lt{left}_tcpbench_-S1000000_-t10_{prefix}{line}2::4'		=> { ipv => "IPv6", proto => "TCP",  op => "Forward", len => "",      streams => "single",       name => "linux-openbsd-linux-tcp6bench-single" },
    'ssh_root@lt{left}_tcpbench_-S1000000_-t10_-n100_{prefix}{line}1.2'		=> { ipv => "IPv4", proto => "TCP",  op => "Receive", len => "",      streams => "parallel-100", name => "linux-openbsd-tcp4bench-parallel" },
    'ssh_root@lt{left}_tcpbench_-S1000000_-t10_-n100_{prefix}{line}1::2'	=> { ipv => "IPv6", proto => "TCP",  op => "Receive", len => "",      streams => "parallel-100", name => "linux-openbsd-tcp6bench-parallel" },
    'ssh_root@lt{left}_tcpbench_-S1000000_-t10_{prefix}{line}1.2'		=> { ipv => "IPv4", proto => "TCP",  op => "Receive", len => "",      streams => "single",       name => "linux-openbsd-tcp4bench-single" },
    'ssh_root@lt{left}_tcpbench_-S1000000_-t10_{prefix}{line}1::2'		=> { ipv => "IPv6", proto => "TCP",  op => "Receive", len => "",      streams => "single",       name => "linux-openbsd-tcp6bench-single" },
    'netbench.pl_-v_-b1000000_-N10_-croot@lt{left}_-sroot@lt{right}_-A{prefix}{line}1.20_-a{prefix}{line}2.40_-t10_tcpsplice'	=> { ipv => "IPv4", proto => "TCP",  op => "Splice",  len => "",      streams => "parallel-10",  name => "linux-openbsd-linux-tcp4splice-parallel" },
    'netbench.pl_-v_-b1000000_-N10_-croot@lt{left}_-sroot@lt{right}_-A{prefix}{line}1::20_-a{prefix}{line}2::40_-t10_tcpsplice'	=> { ipv => "IPv6", proto => "TCP",  op => "Splice",  len => "",      streams => "parallel-10",  name => "linux-openbsd-linux-tcp6splice-parallel" },
    'netbench.pl_-v_-b1000000_-croot@lt{left}_-sroot@lt{right}_-A{prefix}{line}1.20_-a{prefix}{line}2.40_-t10_tcpsplice'	=> { ipv => "IPv4", proto => "TCP",  op => "Splice",  len => "",      streams => "single",       name => "linux-openbsd-linux-tcp4splice-single" },
    'netbench.pl_-v_-b1000000_-croot@lt{left}_-sroot@lt{right}_-A{prefix}{line}1::20_-a{prefix}{line}2::40_-t10_tcpsplice'	=> { ipv => "IPv6", proto => "TCP",  op => "Splice",  len => "",      streams => "single",       name => "linux-openbsd-linux-tcp6splice-single" },
    'netbench.pl_-v_-b1000000_-N10_-croot@lt{left}_-sroot@lt{right}_-A{prefix}{line}1.20_-a{prefix}{line}2.40_-t10_tcpcopy'	=> { ipv => "IPv4", proto => "TCP",  op => "Copy",    len => "",      streams => "parallel-10",  name => "linux-openbsd-linux-tcp4copy-parallel" },
    'netbench.pl_-v_-b1000000_-N10_-croot@lt{left}_-sroot@lt{right}_-A{prefix}{line}1::20_-a{prefix}{line}2::40_-t10_tcpcopy'	=> { ipv => "IPv6", proto => "TCP",  op => "Copy",    len => "",      streams => "parallel-10",  name => "linux-openbsd-linux-tcp6copy-parallel" },
    'netbench.pl_-v_-b1000000_-croot@lt{left}_-sroot@lt{right}_-A{prefix}{line}1.20_-a{prefix}{line}2.40_-t10_tcpcopy'		=> { ipv => "IPv4", proto => "TCP",  op => "Copy",    len => "",      streams => "single",       name => "linux-openbsd-linux-tcp4copy-single" },
    'netbench.pl_-v_-b1000000_-croot@lt{left}_-sroot@lt{right}_-A{prefix}{line}1::20_-a{prefix}{line}2::40_-t10_tcpcopy'	=> { ipv => "IPv6", proto => "TCP",  op => "Copy",    len => "",      streams => "single",       name => "linux-openbsd-linux-tcp6copy-single" },
    'netbench.pl_-v_-B1000000000_-b1000000_-d1_-f0_-i0_-N10_-croot@lt{left}_-sroot@lt{right}_-A{prefix}{line}1.20_-a{prefix}{line}2.40_-t10_udpsplice'		=> { ipv => "IPv4", proto => "UDP",  op => "Splice",  len => "Empty", streams => "parallel-10",  name => "linux-openbsd-linux-udp4splice-empty" },
    'netbench.pl_-v_-B1000000000_-b1000000_-d1_-f0_-i0_-N10_-croot@lt{left}_-sroot@lt{right}_-A{prefix}{line}1::20_-a{prefix}{line}2::40_-t10_udpsplice'	=> { ipv => "IPv6", proto => "UDP",  op => "Splice",  len => "Empty", streams => "parallel-10",  name => "linux-openbsd-linux-udp6splice-empty" },
    'netbench.pl_-v_-B1000000000_-b1000000_-d1_-f1_-i0_-N10_-croot@lt{left}_-sroot@lt{right}_-A{prefix}{line}1.20_-a{prefix}{line}2.40_-t10_udpsplice'		=> { ipv => "IPv4", proto => "UDP",  op => "Splice",  len => "MTU",   streams => "parallel-10",  name => "linux-openbsd-linux-udp4splice-full" },
    'netbench.pl_-v_-B1000000000_-b1000000_-d1_-f1_-i0_-N10_-croot@lt{left}_-sroot@lt{right}_-A{prefix}{line}1::20_-a{prefix}{line}2::40_-t10_udpsplice'	=> { ipv => "IPv6", proto => "UDP",  op => "Splice",  len => "MTU",   streams => "parallel-10",  name => "linux-openbsd-linux-udp6splice-full" },
