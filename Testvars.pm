...
my @netlinkdesc = (
    ...
    'netbench.pl -v -B{bitrate} -b1000000 -d1 -f0 -i0 -N10 -c{left} -a{prefix}{line}1.20 -t10 udpbench'			=> { ipv => "IPv4", proto => "UDP",  op => "Receive", len => "Empty", streams => "parallel-10",  name => "linux-openbsd-udp4bench-parallel-empty" },
    'netbench.pl -v -B{bitrate} -b1000000 -d1 -f0 -i0 -N10 -c{left} -a{prefix}{line}1::20 -t10 udpbench'		=> { ipv => "IPv6", proto => "UDP",  op => "Receive", len => "Empty", streams => "parallel-10",  name => "linux-openbsd-udp6bench-parallel-empty" },
    'netbench.pl -v -B{bitrate} -b1000000 -d1 -f0 -i0 -N10 -c{left} -s{right} -a{prefix}{line}2.40 -t10 udpbench'	=> { ipv => "IPv4", proto => "UDP",  op => "Forward", len => "Empty", streams => "parallel-10",  name => "linux-openbsd-linux-udp4bench-parallel-empty" },
    'netbench.pl -v -B{bitrate} -b1000000 -d1 -f0 -i0 -N10 -c{left} -s{right} -a{prefix}{line}2::40 -t10 udpbench'	=> { ipv => "IPv6", proto => "UDP",  op => "Forward", len => "Empty", streams => "parallel-10",  name => "linux-openbsd-linux-udp6bench-parallel-empty" },
    'netbench.pl -v -B{bitrate} -b1000000 -d1 -f0 -i0 -N10 -s{right} -a{prefix}{line}2.40 -t10 udpbench'		=> { ipv => "IPv4", proto => "UDP",  op => "Send",    len => "Empty", streams => "parallel-10",  name => "openbsd-linux-udp4bench-parallel-empty" },
    'netbench.pl -v -B{bitrate} -b1000000 -d1 -f0 -i0 -N10 -s{right} -a{prefix}{line}2::40 -t10 udpbench'		=> { ipv => "IPv6", proto => "UDP",  op => "Send",    len => "Empty", streams => "parallel-10",  name => "openbsd-linux-udp6bench-parallel-empty" },
    'netbench.pl -v -B{bitrate} -b1000000 -d1 -f1 -i0 -N10 -c{left} -a{prefix}{line}1.20 -t10 udpbench'			=> { ipv => "IPv4", proto => "UDP",  op => "Receive", len => "MTU",   streams => "parallel-10",  name => "linux-openbsd-udp4bench-parallel-mtu" },
    'netbench.pl -v -B{bitrate} -b1000000 -d1 -f1 -i0 -N10 -c{left} -a{prefix}{line}1::20 -t10 udpbench'		=> { ipv => "IPv6", proto => "UDP",  op => "Receive", len => "MTU",   streams => "parallel-10",  name => "linux-openbsd-udp6bench-parallel-mtu" },
    'netbench.pl -v -B{bitrate} -b1000000 -d1 -f1 -i0 -N10 -c{left} -s{right} -a{prefix}{line}2.40 -t10 udpbench'	=> { ipv => "IPv4", proto => "UDP",  op => "Forward", len => "MTU",   streams => "parallel-10",  name => "linux-openbsd-linux-udp4bench-parallel-mtu" },
    'netbench.pl -v -B{bitrate} -b1000000 -d1 -f1 -i0 -N10 -c{left} -s{right} -a{prefix}{line}2::40 -t10 udpbench'	=> { ipv => "IPv6", proto => "UDP",  op => "Forward", len => "MTU",   streams => "parallel-10",  name => "linux-openbsd-linux-udp6bench-parallel-mtu" },
    'netbench.pl -v -B{bitrate} -b1000000 -d1 -f1 -i0 -N10 -s{right} -a{prefix}{line}2.40 -t10 udpbench'		=> { ipv => "IPv4", proto => "UDP",  op => "Send",    len => "MTU",   streams => "parallel-10",  name => "openbsd-linux-udp4bench-parallel-mtu" },
    'netbench.pl -v -B{bitrate} -b1000000 -d1 -f1 -i0 -N10 -s{right} -a{prefix}{line}2::40 -t10 udpbench'		=> { ipv => "IPv6", proto => "UDP",  op => "Send",    len => "MTU",   streams => "parallel-10",  name => "openbsd-linux-udp6bench-parallel-mtu" },
    'netbench.pl -v -B{bitrate} -b1000000 -d1 -f2 -i0 -N10 -c{left} -a{prefix}{line}1.20 -t10 udpbench'			=> { ipv => "IPv4", proto => "UDP",  op => "Receive", len => "Frag2", streams => "parallel-10",  name => "linux-openbsd-udp4bench-parallel-frag" },
    'netbench.pl -v -B{bitrate} -b1000000 -d1 -f2 -i0 -N10 -c{left} -a{prefix}{line}1::20 -t10 udpbench'		=> { ipv => "IPv6", proto => "UDP",  op => "Receive", len => "Frag2", streams => "parallel-10",  name => "linux-openbsd-udp6bench-parallel-frag" },
    'netbench.pl -v -B{bitrate} -b1000000 -d1 -f2 -i0 -N10 -c{left} -s{right} -a{prefix}{line}2.40 -t10 udpbench'	=> { ipv => "IPv4", proto => "UDP",  op => "Forward", len => "Frag2", streams => "parallel-10",  name => "linux-openbsd-linux-udp4bench-parallel-frag" },
    'netbench.pl -v -B{bitrate} -b1000000 -d1 -f2 -i0 -N10 -c{left} -s{right} -a{prefix}{line}2::40 -t10 udpbench'	=> { ipv => "IPv6", proto => "UDP",  op => "Forward", len => "Frag2", streams => "parallel-10",  name => "linux-openbsd-linux-udp6bench-parallel-frag" },
    'netbench.pl -v -B{bitrate} -b1000000 -d1 -f2 -i0 -N10 -s{right} -a{prefix}{line}2.40 -t10 udpbench'		=> { ipv => "IPv4", proto => "UDP",  op => "Send",    len => "Frag2", streams => "parallel-10",  name => "openbsd-linux-udp4bench-parallel-frag" },
    'netbench.pl -v -B{bitrate} -b1000000 -d1 -f2 -i0 -N10 -s{right} -a{prefix}{line}2::40 -t10 udpbench'		=> { ipv => "IPv6", proto => "UDP",  op => "Send",    len => "Frag2", streams => "parallel-10",  name => "openbsd-linux-udp6bench-parallel-frag" },
    ...
    'netbench.pl -v -B{bitrate} -b1000000 -d1 -f0 -i0 -N10 -c{left} -s{right} -A{prefix}{line}1.20 -a{prefix}{line}2.40 -t10 udpsplice'		=> { ipv => "IPv4", proto => "UDP",  op => "Splice",  len => "Empty", streams => "parallel-10",  name => "linux-openbsd-linux-udp4splice-empty" },
    'netbench.pl -v -B{bitrate} -b1000000 -d1 -f0 -i0 -N10 -c{left} -s{right} -A{prefix}{line}1::20 -a{prefix}{line}2::40 -t10 udpsplice'	=> { ipv => "IPv6", proto => "UDP",  op => "Splice",  len => "Empty", streams => "parallel-10",  name => "linux-openbsd-linux-udp6splice-empty" },
    'netbench.pl -v -B{bitrate} -b1000000 -d1 -f1 -i0 -N10 -c{left} -s{right} -A{prefix}{line}1.20 -a{prefix}{line}2.40 -t10 udpsplice'		=> { ipv => "IPv4", proto => "UDP",  op => "Splice",  len => "MTU",   streams => "parallel-10",  name => "linux-openbsd-linux-udp4splice-mtu" },
    'netbench.pl -v -B{bitrate} -b1000000 -d1 -f1 -i0 -N10 -c{left} -s{right} -A{prefix}{line}1::20 -a{prefix}{line}2::40 -t10 udpsplice'	=> { ipv => "IPv6", proto => "UDP",  op => "Splice",  len => "MTU",   streams => "parallel-10",  name => "linux-openbsd-linux-udp6splice-mtu" },
    'netbench.pl -v -B{bitrate} -b1000000 -d1 -f0 -i0 -m1000 -N10 -c{left} -a{prefix}{line}1.20 -t10 udpbench'			=> { ipv => "IPv4", proto => "MMsg",  op => "Receive", len => "Empty", streams => "parallel-10",  name => "linux-openbsd-mmsg4bench-parallel-empty" },
    'netbench.pl -v -B{bitrate} -b1000000 -d1 -f0 -i0 -m1000 -N10 -c{left} -a{prefix}{line}1::20 -t10 udpbench'			=> { ipv => "IPv6", proto => "MMsg",  op => "Receive", len => "Empty", streams => "parallel-10",  name => "linux-openbsd-mmsg6bench-parallel-empty" },
    'netbench.pl -v -B{bitrate} -b1000000 -d1 -f0 -i0 -m1000 -N10 -c{left} -s{right} -a{prefix}{line}2.40 -t10 udpbench'	=> { ipv => "IPv4", proto => "MMsg",  op => "Forward", len => "Empty", streams => "parallel-10",  name => "linux-openbsd-linux-mmsg4bench-parallel-empty" },
    'netbench.pl -v -B{bitrate} -b1000000 -d1 -f0 -i0 -m1000 -N10 -c{left} -s{right} -a{prefix}{line}2::40 -t10 udpbench'	=> { ipv => "IPv6", proto => "MMsg",  op => "Forward", len => "Empty", streams => "parallel-10",  name => "linux-openbsd-linux-mmsg6bench-parallel-empty" },
    'netbench.pl -v -B{bitrate} -b1000000 -d1 -f0 -i0 -m1000 -N10 -s{right} -a{prefix}{line}2.40 -t10 udpbench'			=> { ipv => "IPv4", proto => "MMsg",  op => "Send",    len => "Empty", streams => "parallel-10",  name => "openbsd-linux-mmsg4bench-parallel-empty" },
    'netbench.pl -v -B{bitrate} -b1000000 -d1 -f0 -i0 -m1000 -N10 -s{right} -a{prefix}{line}2::40 -t10 udpbench'		=> { ipv => "IPv6", proto => "MMsg",  op => "Send",    len => "Empty", streams => "parallel-10",  name => "openbsd-linux-mmsg6bench-parallel-empty" },
    'netbench.pl -v -B{bitrate} -b1000000 -d1 -f1 -i0 -N10 -R{ifaddr} -S{ifaddr} -c{left} -s{right} -a234.10.{line}2.10 -t10 udpbench'				=> { ipv => "IPv4", proto => "MCast",  op => "Forward", len => "MTU",   streams => "parallel-10",  name => "linux-openbsd-linux-mcast4bench-parallel-mtu" },
    'netbench.pl -v -B{bitrate} -b1000000 -d1 -f1 -i0 -N10 -R{ifname} -S{ifname} -c{left} -s{right} -aff34:40:fdd7:e83e:66bd:10{line}2::10 -t10 udpbench'	=> { ipv => "IPv6", proto => "MCast",  op => "Forward", len => "MTU",   streams => "parallel-10",  name => "linux-openbsd-linux-mcast6bench-parallel-mtu" },
    'netbench.pl -v -B{bitrate} -b1000000 -d1 -f1 -i0 -N10 -R{ifaddr} -S{ifaddr} -c{left} -a234.10.{line}1.10 -t10 udpbench'					=> { ipv => "IPv4", proto => "MCast",  op => "Receive", len => "MTU",   streams => "parallel-10",  name => "linux-openbsd-mcast4bench-parallel-mtu" },
    'netbench.pl -v -B{bitrate} -b1000000 -d1 -f1 -i0 -N10 -R{ifname} -S{ifname} -c{left} -aff34:40:fdd7:e83e:66bd:10{line}1::10 -t10 udpbench'			=> { ipv => "IPv6", proto => "MCast",  op => "Receive", len => "MTU",   streams => "parallel-10",  name => "linux-openbsd-mcast6bench-parallel-mtu" },
    'netbench.pl -v -B{bitrate} -b1000000 -d1 -f1 -i0 -N10 -R{ifaddr} -S{ifaddr} -s{right} -a234.10.{line}2.10 -t10 udpbench'					=> { ipv => "IPv4", proto => "MCast",  op => "Send",    len => "MTU",   streams => "parallel-10",  name => "openbsd-linux-mcast4bench-parallel-mtu" },
    'netbench.pl -v -B{bitrate} -b1000000 -d1 -f1 -i0 -N10 -R{ifname} -S{ifname} -s{right} -aff34:40:fdd7:e83e:66bd:10{line}2::10 -t10 udpbench'		=> { ipv => "IPv6", proto => "MCast",  op => "Send",    len => "MTU",   streams => "parallel-10",  name => "openbsd-linux-mcast6bench-parallel-mtu" },
