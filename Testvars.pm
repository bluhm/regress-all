...
my @testdesc = (
    ...
    'iperf3_-c{prefix}{line}1.50_-P10_-t10_-R'		=> { ipv => "IPv4", proto => "TCP",  op => "Receive", len => "",      streams => "parallel-10", name => "linux-openbsd-tcp4iperf-parallel" },
    'iperf3_-c{prefix}{line}2.80_-P10_-t10'		=> { ipv => "IPv4", proto => "TCP",  op => "Send",    len => "",      streams => "parallel-10", name => "openbsd-linux-tcp4iperf-parallel" },
    'iperf3_-6_-c{prefix}{line}1::50_-P10_-t10_-R'	=> { ipv => "IPv6", proto => "TCP",  op => "Receive", len => "",      streams => "parallel-10", name => "linux-openbsd-tcp6iperf-parallel" },
    'iperf3_-6_-c{prefix}{line}2::80_-P10_-t10'		=> { ipv => "IPv6", proto => "TCP",  op => "Send",    len => "",      streams => "parallel-10", name => "openbsd-linux-tcp6iperf-parallel" },
);
