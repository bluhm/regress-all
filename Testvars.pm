...
my @netlinkdesc = (
    ...
    'netbench.pl -v -B{bitrate} -b1000000 -d1 -f1 -i0 -N10 -R{ifaddr} -S{ifaddr} -c{left} -s{right} -a234.10.{line}2.10 -t10 udpbench'				=> { ipv => "IPv4", proto => "MCast",  op => "Forward", len => "MTU",   streams => "parallel-10",  name => "linux-linux-mcast4bench-parallel-mtu" },
    'netbench.pl -v -B{bitrate} -b1000000 -d1 -f1 -i0 -N10 -R{ifname} -S{ifname} -c{left} -s{right} -aff34:40:fdd7:e83e:66bd:10{line}2::10 -t10 udpbench'	=> { ipv => "IPv6", proto => "MCast",  op => "Forward", len => "MTU",   streams => "parallel-10",  name => "linux-linux-mcast6bench-parallel-mtu" },
