...
my @testdesc = (
    ...
    'netbench.pl_-v_-B1000000000_-b1000000_-d1_-f1_-i0_-N10_-c{left}_-s{right}_-A{prefix}{line}1.20_-a{prefix}{line}2.40_-t10_udpsplice'	=> { ipv => "IPv4", proto => "UDP",  op => "Splice",  len => "MTU",   streams => "parallel-10",  name => "linux-openbsd-linux-udp4splice-full" },
    'netbench.pl_-v_-B1000000000_-b1000000_-d1_-f1_-i0_-N10_-c{left}_-s{right}_-A{prefix}{line}1::20_-a{prefix}{line}2::40_-t10_udpsplice'	=> { ipv => "IPv6", proto => "UDP",  op => "Splice",  len => "MTU",   streams => "parallel-10",  name => "linux-openbsd-linux-udp6splice-full" },
    ...
    'iperf3_-c{prefix}{line}1.1_{window}_-P15_-t10_-R'			=> { ipv => "IPv4", proto => "TCP",  op => "Receive", len => "",      streams => "parallel-15", name => "linux-openbsd-tcp4iperf-parallel" },
    'iperf3_-c{prefix}{line}2.4_{window}_-P15_-t10'			=> { ipv => "IPv4", proto => "TCP",  op => "Send",    len => "",      streams => "parallel-15", name => "openbsd-linux-tcp4iperf-parallel" },
    'ssh_{left}_iperf3_-c{prefix}{line}2.4_{window}_-P15_-t10'		=> { ipv => "IPv4", proto => "TCP",  op => "Forward", len => "",      streams => "parallel-15", name => "linux-openbsd-linux-tcp4iperf-parallel" },
    'iperf3_-6_-c{prefix}{line}1::1_{window}_-P15_-t10_-R'		=> { ipv => "IPv6", proto => "TCP",  op => "Receive", len => "",      streams => "parallel-15", name => "linux-openbsd-tcp6iperf-parallel" },
    'iperf3_-6_-c{prefix}{line}2::4_{window}_-P15_-t10'			=> { ipv => "IPv6", proto => "TCP",  op => "Send",    len => "",      streams => "parallel-15", name => "openbsd-linux-tcp6iperf-parallel" },
    'ssh_{left}_iperf3_-6_-c{prefix}{line}2::4_{window}_-P15_-t10'	=> { ipv => "IPv6", proto => "TCP",  op => "Forward", len => "",      streams => "parallel-15", name => "linux-openbsd-linux-tcp6iperf-parallel" },
    'iperf3_-c{prefix}{line}1.5{multiple}_{window}_-P15_-t10_-R'		=> { ipv => "IPv4", proto => "TCP",  op => "Receive", len => "",      streams => "parallel-30", name => "linux-openbsd-tcp4iperf-multiple" },
    'iperf3_-c{prefix}{line}2.8{multiple}_{window}_-P15_-t10'			=> { ipv => "IPv4", proto => "TCP",  op => "Send",    len => "",      streams => "parallel-30", name => "openbsd-linux-tcp4iperf-multiple" },
    'ssh_{multileft}_iperf3_-c{prefix}{line}2.8{multiple}_{window}_-P15_-t10'	=> { ipv => "IPv4", proto => "TCP",  op => "Forward", len => "",      streams => "parallel-30", name => "linux-openbsd-linux-tcp4iperf-multiple" },
    'iperf3_-6_-c{prefix}{line}1::5{multiple}_{window}_-P15_-t10_-R'		=> { ipv => "IPv6", proto => "TCP",  op => "Receive", len => "",      streams => "parallel-30", name => "linux-openbsd-tcp6iperf-multiple" },
    'iperf3_-6_-c{prefix}{line}2::8{multiple}_{window}_-P15_-t10'		=> { ipv => "IPv6", proto => "TCP",  op => "Send",    len => "",      streams => "parallel-30", name => "openbsd-linux-tcp6iperf-multiple" },
    'ssh_{multileft}_iperf3_-6_-c{prefix}{line}2::8{multiple}_{window}_-P15_-t10'	=> { ipv => "IPv6", proto => "TCP",  op => "Forward", len => "",      streams => "parallel-30", name => "linux-openbsd-linux-tcp6iperf-multiple" },
);
