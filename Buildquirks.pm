...
# OpenBSD 7.6, newvers 2024-09-23Z
    '2024-09-30T15:00:54Z' => {
	comment => "OpenBSD/amd64 7.6 release",
	release => '7.6',
    },
# OpenBSD 7.7, newvers 2025-04-12Z
    '2025-04-13T14:35:59Z' => {
...
# OpenBSD 7.7, newvers 2024-10-08Z
    ...
    '2026-02-26T07:42:25Z' => {
	comment => "pledge tmppath",
	updatedirs => [
	    "sys",
	...
	buildcommands => [
	    ...
	    "make -C gnu/usr.bin/binutils-2.17 -f Makefile.bsd-wrapper all",
	    "make -C gnu/usr.bin/binutils-2.17 -f Makefile.bsd-wrapper install",
	    "make -C gnu/usr.bin/texinfo -f Makefile.bsd-wrapper obj",
	    "make -C gnu/usr.bin/texinfo -f Makefile.bsd-wrapper all",
	    "make -C gnu/usr.bin/texinfo -f Makefile.bsd-wrapper install",
